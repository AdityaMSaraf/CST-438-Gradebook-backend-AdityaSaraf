INSERT INTO course (year, semester, course_id, title, instructor)
VALUES (2020, 'Fall', 30157, 'BUS 203 - Financial Accounting', 'cchou@csumb.edu'),
       (2020, 'Fall', 30163, 'BUS 306 - Fundamentals of Marketing', 'anariswari@csumb.edu'),
       (2020, 'Fall', 30291, 'BUS 304 - Business Communication, Pro-seminar & Critical Thinking',
        'kposteher@csumb.edu'),
       ...
       (2021, 'Fall', 40443, 'CST 101 - Introduction to Programming', 'jgross@csumb.edu')
;

insert into assignment (id, due_date, name, course_id)
values (1, '2021-09-01', 'db design', 31045),
       (2, '2021-09-02', 'requirements', 31045),
       (3, '2023-09-02', 'agile', 40443),
       (4, '2023-09-02', 'unit testing', 40443)
;

insert into enrollment (id, student_email, student_name, course_id)
values (1, 'test@csumb.edu', 'test', 31045),
...
values ('user@csumb.edu', '$2a$10$3XpwR7rg4/kUoyew/GPd8uJLNmesRU/9e77FDW5aMvK60QWwjus/K', 'USER'),
